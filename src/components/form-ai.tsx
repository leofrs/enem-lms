...
const FormAi = () => {
    ...
    return (
        <div className="mt-8 flex items-center justify-center bg-gray-50">
            <Card className="w-full max-w-md p-2">
                <CardHeader className="space-y-1">
                    <CardTitle className="text-2xl font-bold text-center">Pergunte a A.I!</CardTitle>
                    <CardDescription className="text-center">Aprenda com a A.I!</CardDescription>
                </CardHeader>
                <CardContent>
